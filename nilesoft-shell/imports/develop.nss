...
{
	menu(mode="multiple" type="file|dir|back" title="Git Options" image=\uE22C)
	{
	...
	menu(mode="single" title='Editors' image=\uE17A)
	{
		...
		item(title='JetBrains Rider C#' image='C:\Users\nirbhaykwatra\AppData\Local\Programs\Rider\bin\rider64.exe' cmd='rider' args='"@sel.path"')
		item(title='JetBrains PyCharm' image='C:\Users\nirbhaykwatra\AppData\Local\Programs\PyCharm Community\bin\pycharm64.exe' cmd='pycharm' args='"@sel.path"')
		separator

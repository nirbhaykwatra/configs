...
modify(find="Checkout" menu="TortoiseSVN")
modify(find="unpin*" pos="bottom" menu="Pin/Unpin")
modify(find="pin*" pos="top" menu="Pin/Unpin")

modify(find="Open with Visual Studio" menu="Develop/Editors")
modify(find="Git" menu="Develop/Git Options")
modify(find="New folder with selection" pos=1)
